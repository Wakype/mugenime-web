import { Info, Play, Share2, BookmarkPlus } from "lucide-react";
    ...
    <div className="relative min-h-screen bg-background pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-[5vh] md:pt-[15vh] relative z-10">
        ...
        <div className="flex flex-col gap-6 lg:hidden">
          {/* Poster Skeleton (3:4 Aspect Ratio) */}
          ...
          {/* Info Box Skeleton */}
          <div className="bg-card rounded-2xl p-5 border border-border h-64 animate-pulse" />
        ...
        <div className="hidden lg:grid grid-cols-12 gap-10">
          ...
          <div className="col-span-3 space-y-6">
            ...
            <div className="bg-card rounded-2xl p-5 border border-border space-y-4 shadow-sm h-72 animate-pulse">
